...
plot(mice$conc, seq(0,1,length=length(mice$conc)),type='n', fg='grey', 
     ...
     las=1, main=expression(rho),cex.main=2)
points(mice$conc, mice$dead/mice$numSubj, pch=20, col='red', cex=2)
lines(newconc, p1, col='red', lwd=3)
points(mice$conc, mice$p2, pch=20, cex=2, col='green')
lines(newconc, p2, col='green', lwd=3)
points(mice$conc, 1-mice$p2, pch=20, cex=2, col='blue')
lines(newconc, p3, col='blue', lwd=3)
